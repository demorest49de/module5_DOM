...
console.log('addItemEditBtn: ', addItemEditBtn);
console.log('addItemIdNumber: ', addItemIdNumber);
console.log('addItemForm: ', addItemForm);
console.log('addItemCheckbox: ', addItemCheckbox);
console.log('addItemDiscount: ', addItemDiscount);
console.log('addItemTotalValue: ', addItemTotalValue);